...
const featured = USE_CASES.filter((u) => u.href);
const scenarios = USE_CASES.filter((u) => !u.href);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="text-[#1d9e75]">already live.</span>
          </h2>
          <p className="mt-3 text-sm sm:text-base text-[#6b6b6b]">
            Explore live demo stores and see how different verticals use Torq Orbit — no fabricated
            reviews.
          </p>
        </motion.div>

        {/* Featured live stores */}
